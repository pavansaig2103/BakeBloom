  ...
  return (
    <footer className="mt-16 bg-ganache text-cream">
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 md:grid-cols-3 lg:px-8">
        <div>
          <h3 className="font-display text-2xl font-bold">BakeBloom</h3>
          <p className="mt-3 text-sm text-cream/75">Premium cakes, pastries, and custom celebration desserts baked fresh every day.</p>
        </div>
        <div>
          <h4 className="font-semibold">Contact</h4>
          <p className="mt-3 text-sm text-cream/75">Phone: +91 98765 43210</p>
          <p className="text-sm text-cream/75">Email: hello@bakebloom.in</p>
        </div>
        <div>
